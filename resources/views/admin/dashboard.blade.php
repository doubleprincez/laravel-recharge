                                ...
                                <div class="x_content">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        @foreach($users as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm btn-round"
                                                            data-toggle="modal" data-target="#edituser-{{$item->id}}">
                                                        Edit
                                                    </button>

                                                    <button type="button" class="btn btn-danger btn-sm btn-round"
                                                            data-toggle="modal" data-target="#deluser-{{$item->id}}">
                                                        Delete
                                                    </button>

                                                    <button type="button" class="btn btn-info btn-sm btn-round"
                                                            data-toggle="modal" data-target="#bonuses-{{$item->id}}">
                                                        Bonuses
                                                    </button>
                                                    ...
                                                    @if($item->special==0)
                                                        <button type="submit "
                                                                class="btn btn-info btn-sm btn-round btn-sm"
                                                        ><a href="{{route('user.special', ['id'=>$item->id])}}">Make
                                                                Special</a>
                                                        </button>
                                                    ...
                                                    @else
                                                        <button type="submit "
                                                                class="btn btn-info btn-sm btn-round btn-sm"
                                                        ><a href="{{route('user.specialunset', ['id'=>$item->id])}}">Remove
                                                                Special</a>
                                                        </button>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header border-bottom-0">
                                                            <h5 class="modal-title" id="exampleModalLabel">User's
                                                                Details {{$item->name}}</h5>
                                                            ...
                                                            <form class="form-horizontal form-label-left input_mask"
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                                    <input type="password" class="form-control"
                                                                           id="inputSuccess5" name="password"
                                            ...
                                            <div class="modal fade" id="deluser-{{$item->id}}" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal form-label-left input_mask">
                                                                ...
                                                                <h3 class="text-center text-danger">Sure to
                                                                    delete {{$item->name}} from user's list?</h3>
                                            ...
                                            <!-- user Bonuses -->
                                            <div class="modal fade" id="bonuses-{{$item->id}}" tabindex="-1"
                                                 role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header border-bottom-0">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row tile_count">
                                                                <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <form action="{{route('card.reset', ['id'=>$item->id])}}"
                                                                              method="GET">
                                                                            @csrf
                                                                            <button type="submit" id="creset"
                                                                                    class="btn btn-sm btn-danger">Reset
                                                                            </button>
                                                                        </form>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <button type="button"
                                                                                ...
                                                                                id="cedit" onclick="Card()">Edit
                                                                        </button>
                                                                    </div>


                                                                    <form action="{{route('card.update', ['id'=>$item->id])}}"
                                                                          method="GET">
                                                                        @csrf
                                                                        <input type="text" class="form-control"
                                                                               name="cbonus" id="cbonus"
                                                                               placeholder="New Card Bonus">
                                                                        <br>

                                                                        <button type="submit" name="cupdate"
                                                                ...
                                                                <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                                                                    <span class="count_top"><i
                                                                                class="fa fa-clock-o"></i> Monthly Bonus </span>
                                                                    <div class="count">{{$item->monthly_bonus}}</div>
                                                                    <div class="col-md-6">
                                                                        <form action="{{route('monthly.reset', ['id'=>$item->id])}}"
                                                                              method="GET">
                                                                            <button type="submit" name="mreset"
                                                                                    id="mreset"
                                                                                    class="btn btn-sm btn-danger">Reset
                                                                            </button>
                                                                        </form>
                                                                    ...
                                                                    <form action="{{route('monthly.update', ['id'=>$item->id])}}"
                                                                          method="GET">
                                                                        @csrf
                                                                        <input type="text" class="form-control"
                                                                               name="mbonus" id="mbonus"
                                                                ...
                                                                <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <form action="{{route('travel.reset', ['id'=>$item->id])}}"
                                                                              method="GET">
                                                                            <button type="submit" name="treset"
                                                                                    id="treset"
                                                                                    class="btn btn-sm btn-danger">Reset
                                                                            </button>
                                                                        </form>
                                                                    ...
                                                                    <form action="{{route('travel.update', ['id'=>$item->id])}}"
                                                                          method="GET">
                                                                        @csrf
                                                                        <input type="text" class="form-control"
                                                                               name="tbonus" id="tbonus"
                                                                               placeholder="New Travelling Bonus">
                                                                        <br>
                                                                        <button type="submit" name="tupdate"
                                                                                class="btn btn-sm btn-primary btn-block"
                                                                                id="tupdate">
                                                                            Update
                                                                        </button>
                                                                ...
                                                                <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <form action="{{route('festival.reset', ['id'=>$item->id])}}"
                                                                              method="get">
                                                                            @csrf
                                                                            <button type="submit" name="freset"
                                                                                    id="freset"
                                                                                    class="btn btn-sm btn-danger">Reset
                                                                            </button>
                                                                        </form>
                                                                    ...
                                                                    <form action="{{route('festival.update', ['id'=>$item->id])}}"
                                                                          method="get">
                                                                        @csrf
                                                                        <input type="text" class="form-control"
                                                                               name="fbonus" id="fbonus"
                                                                               placeholder="New Festival Bonus">
                                                                        <br>
                                                                        <button type="submit" name="fupdate"
                                                                                class="btn btn-sm btn-primary btn-block"
                                                                                id="fupdate">
                                                                            Update
                                                                        </button>
