        ...
        <!-- top navigation -->
                                ...
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                                   aria-expanded="false">
                                    <img src="{{asset(auth()->user()->avatar?'/storage/'.auth()->user()->avatar:'img/default-avatar.png')}}"
                                         alt="">{{asset(auth()->user()->name?auth()->user()->name:'No Name')}}
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12" data-toggle="modal"
                         data-target="#form">
